...
if (isset($_GET['idmaquina'])) {
  $colname_Recordset1 = $_GET['idmaquina'];
}
$conexion = conectar();
$query_Recordset1 = sprintf("SELECT * FROM personal WHERE idmaquina = %s ORDER BY idpersonal ASC", GetSQLValueString($colname_Recordset1, "int"));
...
<div class="datagrid">
<table>
<thead><h1>Lista de personal por maquina</h1>
<a href="pdf_personal2.php?idmaquina=<?php echo $row_Recordset1['idmaquina'];?>"  target="_blank" style=" text-decoration: none;"><img src='../imagenes/imprimira.PNG' title=' IMPRIMIR PERSONAL POR TURNO'> </img ></a>
</thead>
