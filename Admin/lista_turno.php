...
<div class="datagrid">
<table>
<thead><h1>Lista de Turnos</h1> </thead><span>

<a href="R_turnos.php" style=" text-decoration: none;"> <img src='../imagenes/Registros.PNG' title='Agregar turno'>  </img ></a>  <?php echo $totalRows_Recordset1 ?> Registros en Total </span>
   <thead><tr>
  <th>Numero del turno</th><th>Tiempo del turno</th>
  <th colspan="4">Accion</th></tr></thead>
  <?php $i = 0; ?>
  <?php do { ?>
    <tr <?php echo $i++ % 2 ? 'class=""' : 'class="alt"'; ?>>

      <td><?php echo $row_Recordset1['numTurno']; ?></td>
      <td class="active"><?php echo $row_Recordset1['tiempoTurno']; ?></td>

      <td><a href="perfturn.php?idturno=<?php echo $row_Recordset1['idturno']; ?>" ><img src='../imagenes/USER.png' title='Personal por turno'></img ></a></td>
  <td><a href="actualizar_turno.php?idturno=<?php  echo $row_Recordset1['idturno']; ?>"><img src='../imagenes/editar.png' title='Editar turno'></img ></a></td>
