...
$FE2 = $_GET['fechaPro1'];
    ...
    echo" <h1> Tubos de segunda calidad negra </h1>";
     ?>
       <form action="grafica_calidad8.php" method="get">
     <table align="center" border="0">
        <tr>
       <td>Desde:<input type="date" name="fechaPro" /></td>
       <td>Hasta:<input type="date" name="fechaPro1" /></td>
              <td><a href="grafica_calidad2n.php" style=" text-decoration: none; color: rgba(11, 11, 11, 1);" title="Grafica principal">Produccion total</a> </td>
...
$sql2="SELECT sum(cali1) as total, numTurno FROM produccion p, turno c where p.idturno='".$datos['idturno']."'  AND fechaPro BETWEEN '$FE1' AND '$FE2' AND  c.idturno=p.idturno group by numTurno";
  ...
  @extract($r3);
	 ...
	 $cantpro[] = $total;
                        ...
                        $turn = "turno";
    $strXML = "<chart bgAlpha='1,1' canvasBgAlpha='0' caption='Grafica de produccion' xAxisName='Turnos' yAxisName='Segunda calidad negra'>";
	  ...
	  echo renderChart("FusionCharts/pastel3D.swf", "", $strXML, "myFirst", 900, 450, false, true, true);
    ?>
