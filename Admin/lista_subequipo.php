...
$conexion = conectar();
$query_Recordset1 = "SELECT * FROM sub_equipo";
...
<div class="datagrid">
<table>
<thead><h1>Lista de Subequipos</h1></thead><span>

<a href="R_subequipos.php" style=" text-decoration: none;" "> <img src='../imagenes/Registros.PNG' title='Registrar Subequipo'>  </img ></a>  <?php echo $totalRows_Recordset1 ?> Registros en Total </span>
  <thead><tr>
  <th colspan="4">Nombre de Subequipos</th>
  </tr></thead>
  <?php $i = 0; ?>
  <?php do { ?>
    <tr <?php echo $i++ % 2 ? 'class=""' : 'class="alt"'; ?>>

      <td><?php echo $row_Recordset1['nombre_subequipo']; ?></td>
