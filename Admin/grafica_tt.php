...
$(function() {
    ...
    ?>
            <form action="grafica_tt2.php" method="get">
...
SELECT * FROM produccion group by idturno
	...
	while($datos=mysql_fetch_array($cursor)){
     ...
     $sql2="SELECT sum(tt) as total, numTurno FROM produccion p, turno c where p.idturno='".$datos['idturno']."' AND  c.idturno=p.idturno group by numTurno";
