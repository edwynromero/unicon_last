...
$conexion = conectar();
$query_Recordset1 = "SELECT * FROM maquina ORDER BY numeroMaq";
...
<div class="datagrid">
<table>
<thead><h1>Lista de Maquinas</h1></thead><span>

<a href="R_maquina.php" style=" text-decoration: none;"> <img src='../imagenes/Registros.PNG' title='Agregar maquina'>  </img ></a>  <?php echo $totalRows_Recordset1 ?> Registros en  Total </span>
  <thead><tr>
  <th>Numero de la maquina</th><th>Descripcion</th>
  <th colspan="4">Accion</th></tr></thead>
  <?php $i = 0; ?>
  <?php do { ?>
    <tr <?php echo $i++ % 2 ? 'class=""' : 'class="alt"'; ?>>

      <td><?php echo $row_Recordset1['numeroMaq']; ?></td>
      <td class="active"><?php echo $row_Recordset1['descripcion']; ?></td>

      <td><a href="perfMaq.php?idmaquina=<?php echo $row_Recordset1['idmaquina']; ?>" ><img src='../imagenes/USER.png' title='Personal en maquina'></img></a>
</td>
<td><a href="actualizar_maquina.php?idmaquina=<?php  echo $row_Recordset1['idmaquina']; ?>" ><img src='../imagenes/editar.png' title='Editar maquina'></img ></a>
   </td>
