...
$(function() {
    ...
    echo" <h1> Tubos de tercera calidad </h1>";
    ?>
...
SELECT * FROM produccion group by idturno
	...
	while($datos=mysql_fetch_array($cursor)){
     ...
     $sql2="SELECT sum(cali3) as total, numTurno FROM produccion p, turno c where p.idturno='".$datos['idturno']."' AND  c.idturno=p.idturno group by numTurno";
