<?php
      ...
      function buscar($b) {
           $conexion = conectar();
            ...
            $sql = mysql_query("SELECT * FROM turno WHERE numTurno LIKE '%".$b."%'   ",$conexion );
...
<div style="  margin: 0px 0px 0px -300px;">
    <div class="datagrid" >
                       ...
                       <thead>
                        <tr>
                           <th>Numero del turno</th><th>Tiempo del turno</th><th colspan="4">Accion</th>
 </tr></thead>
               <?php
     ...
     <td><?php echo $numTurno; ?></td>
      <td class="active"><?php echo $tiempoTurno; ?></td>



        <td><a href="perfturn.php?idturno=<?php echo $idturno; ?>" ><img src='../imagenes/USER.png' title='Ver perfil'></img ></a></td>
  <td><a href="actualizar_turno.php?idturno=<?php  echo $idturno; ?>"><img src='../imagenes/editar.png' title='Editar perfil'></img ></a></td>
