...
$conexion = conectar();
$query_Recordset1 = "SELECT * FROM personal";
...
<div class="datagrid">
<table>
<thead><h1>Lista de personal</h1></thead><span>

<a href="R_personal.php" style=" text-decoration: none;" "> <img src='../imagenes/Registros.PNG' title='Registrar personal'>  </img ></a>  <?php echo $totalRows_Recordset1 ?> Registros en Total </span>
  <thead><tr>
  <th>Nombre</th><th>Apellido</th><th>N&deg; de ficha</th><th>Cargo</th>
  ...
  <?php do { ?>
    <tr <?php echo $i++ % 2 ? 'class=""' : 'class="alt"'; ?>>
      ...
      <td class="active"><?php echo $row_Recordset1['apellido']; ?></td>
      <td><?php echo $row_Recordset1['NFicha']; ?></td>
      <td class="active"><?php echo $row_Recordset1['cargo']; ?></td>

      <td><a href="perfPers.php?idpersonal=<?php echo $row_Recordset1['idpersonal']; ?>" ><img src='../imagenes/USER.png' title='Ver perfil'></img ></a></td>
  <td><a href="actualizar_personal.php?idpersonal=<?php  echo $row_Recordset1['idpersonal']; ?>"><img src='../imagenes/editar.png' title='Editar perfil'></img ></a></td>

 <td><a href="borrar_personal.php?idpersonal=<?php  echo $row_Recordset1['idpersonal']; ?>" ><img src='../imagenes/eliminar.gif' title='Eliminar'></img ></a></td>
