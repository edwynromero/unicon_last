...
<form method="post" action="#"  name="Nue_Insc" id="Nue_Insc">
  ...
  <input type="text" pattern="[A_-Za_-z]{1,10}"   name="numeroMaq" size="12" maxlength="2" required onkeypress="return numeros(event)" title="Por favor ingresar el numero de la maquina." >
  </p>
  <p>
    <label for="password">Descripcion de la maquina:</label>
  <textarea maxlength="150"  name="descripcion" title="Por favor ingresar la descripcion de la maquina."  required></textarea>
  </p>
 
  
  </div>
  <p class="p-container">
   <input name="enviar_maquina" class="botonsubmit" type="submit" value="Ingresar">
...
if (isset($_REQUEST['enviar_maquina'])) {
   insert_maquina();
