<?php
      ...
      function buscar($b) {
           $conexion = conectar();
            ...
            $sql = mysql_query("SELECT * FROM productos WHERE descripcion LIKE '%".$b."%' OR codigoPrd LIKE '%".$b."%'OR pesoProd LIKE '%".$b."%' or ordenFabric LIKE '%".$b."%'  ",$conexion );
...
<div style="  margin: 0px 0px 0px -300px;">
    <div class="datagrid" >
                       ...
                       <thead>
                        <tr>
                           <th>Producto</th><th>Codigo</th><th>Peso</th><th colspan="3">Accion</th>
 </tr></thead>
               <?php
     ...
     <td><?php echo $descripcion; ?></td>
      <td class="active"><?php echo $codigoPrd; ?></td>

      <td class="active"><?php echo $pesoProd; ?></td>




<td><a href="actualizar_producto.php?idproductos=<?php  echo $row['idproductos']; ?>"><img src='../imagenes/editar.png' title='Editar perfil'></img ></a></td>

 <td><a href="borrar_productos.php?idproductos=<?php  echo $row['idproductos']; ?>" ><img src='../imagenes/eliminar.gif' title='Eliminar'></img ></a></td>
                     </tr>
