...
$conexion = conectar();
$query_Recordset1 = "SELECT  * FROM asistencias ORDER BY fecha_asistencia";
...
<?php echo $totalRows_Recordset1 ?> Registros en Total </span>
  <thead><tr>
  <th>Fecha de asistencias</th> <th>Turno</th> 
  <th colspan="1">Accion</th></tr></thead>
  <?php $i = 0; ?>
  <?php do { ?>
    <tr <?php echo $i++ % 2 ? 'class=""' : 'class="alt"'; ?>>

      <td><?php echo $row_Recordset1['fecha_asistencia']; ?></td>
      <td class="active"><?php echo $row_Recordset1['idturno']; ?></td>
  
    

      <td><a href="perfAsis.php?id_asistencia=<?php echo $row_Recordset1['id_asistencia']; ?>" ><img src='../imagenes/USER.png' title='Ver perfil'></img ></a></td>
