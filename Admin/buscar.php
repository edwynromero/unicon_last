 <?php
      ...
      function buscar($b) {
           $conexion = conectar();
            ...
            $sql = mysql_query("SELECT * FROM personal WHERE cargo LIKE '%".$b."%' OR nombre LIKE '%".$b."%'OR NFicha LIKE '%".$b."%'  ",$conexion );
...
<div style="  margin: 0px 0px 0px -300px;">
    <div class="datagrid" >
      ...
      <td class="active"><?php echo $apellido; ?></td>
      <td><?php echo $NFicha; ?></td>
      <td class="active"><?php echo $cargo; ?></td>

        <td><a href="perfPers.php?idpersonal=<?php echo $row['idpersonal']; ?>" ><img src='../imagenes/USER.png' title='Ver perfil'></img ></a>
</td>
...
<td><a href="borrar_personal.php?idpersonal=<?php  echo $row['idpersonal']; ?>" ><img src='../imagenes/eliminar.gif' title='Eliminar'></img ></a></td>
                     </tr>
