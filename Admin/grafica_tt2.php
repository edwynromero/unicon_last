    ...
    echo" <h1> Tiempo Total  </h1>";
     ...
     <table align="center" border="0">
       ...
       <td>Hasta:<input type="date" name="fechaPro1" /></td>
              <td><a href="grafica_tt.php" style=" text-decoration: none; color: rgba(11, 11, 11, 1);" title="Grafica principal">Produccion total</a> </td>
...
$sql2="SELECT sum(tt) as total, numTurno FROM produccion p, turno c where p.idturno='".$datos['idturno']."'  AND fechaPro BETWEEN '$FE1' AND '$FE2' AND  c.idturno=p.idturno group by numTurno";
