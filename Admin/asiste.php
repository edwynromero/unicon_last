...
$sql="update personal set estado=2 where idpersonal=$id AND idturno=$idturno AND idmaquina=$idmaquina";
...
$sql2="insert into asistencias (id_personal_asistencia,fecha_asistencia,estado_asistencia,idturno,idmaquina) values ('$id','$fecha',2,$idturno,$idmaquina)";
