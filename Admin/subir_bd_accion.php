...
<?php
	...
	if ( !@function_exists( 'gzopen' ) ) {
		$hay_Zlib = false;
		echo( "- Ya que no está disponible Winrar, usaré el BackUp de la Base de Datos: '$filename'<br>" );
	}
	else {
		$hay_Zlib = true;
		$filename = $filename;
		echo( "- Ya que está disponible Winrar, usaré el BackUp de la Base de Datos: '$filename'<br>" );
	}
