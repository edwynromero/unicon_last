...
$conexion = conectar();
$query_Recordset1 = "SELECT * FROM produccion order by fechaPro";
...
<div class="datagrid">
<table>
<thead><h1>Lista de Produccion</h1></thead><span>

<a href="R_produccion.php" style=" text-decoration: none;"> <img src='../imagenes/Registros.PNG' title='Registrar produccion'>  </img ></a>  </span>
    <?php echo $totalRows_Recordset1 ?> Registros en Total </span>
  <thead>
  <tr>
  <th>Supervisor</th>
  <th>Fecha</th>
 ...
 $idp=$row_Recordset1['idpersonal'];
  ...
  ?>
    <tr <?php echo $i++ % 2 ? 'class=""' : 'class="alt"'; ?>>
      ...
      <td class="active"><?php echo $row_Recordset1['fechaPro']; ?></td>
      <td><?php echo $numeroMaq; ?></td>
      <td class="active"><?php echo $numTurno; ?></td>

      <td><a href="perfProd.php?idproduccion=<?php echo $row_Recordset1['idproduccion']; ?>" ><img src='../imagenes/USER.png' title='Ver perfil de la produccion'></img ></a></td>
