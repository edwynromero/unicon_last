...
$sql2="SELECT sum(tmu) as total, numTurno FROM produccion p, turno c where p.idturno='".$datos['idturno']."'  AND fechaPro BETWEEN '$FE1' AND '$FE2' AND  c.idturno=p.idturno group by numTurno";
