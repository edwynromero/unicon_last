<?php
      ...
      function buscar($b) {
           $conexion = conectar();
            ...
            $sql = consultar("SELECT * FROM maquina WHERE descripcion LIKE '%".$b."%' OR numeroMaq LIKE '%".$b."%'  ",$conexion );
...
<div style="  margin: 0px 0px 0px -300px;">
  ...
  <th colspan="4">Accion</th></tr></thead>
     ...
     <td><?php echo $numeroMaq; ?></td>
      <td class="active"><?php echo $descripcion; ?></td>




        <td><a href="perfMaq.php?idmaquina=<?php echo $row['idmaquina']; ?>" ><img src='../imagenes/USER.png' title='Ver perfil'></img ></a>
</td>
<td><a href="actualizar_maquina.php?idmaquina=<?php  echo $row['idmaquina']; ?>"><img src='../imagenes/editar.png' title='Editar perfil'></img ></a>
   </td>
                     </tr>
