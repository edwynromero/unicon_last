...
<div class="datagrid">
<table>
<thead><h1>Lista de productos</h1></thead><span>
          
<a href="R_productos.php" style=" text-decoration: none;"> <img src='../imagenes/Registros.PNG' title='Registrar producto'>  </img ></a>  <?php echo $totalRows_Recordset1 ?> Registros en  Total </span>
  <thead><tr>
  <th colspan="1">Producto</th><th>Codigo</th><th>Peso</th><th>Orden</th><th>Tiras</th>
  <th colspan="4">Accion</th></tr></thead>
  <?php $i = 0; ?>
  <?php do { ?>
    <tr <?php echo $i++ % 2 ? 'class=""' : 'class="alt"'; ?>>
      <td><?php echo $row_Recordset1['descripcion']; ?></td>
      <td><?php echo $row_Recordset1['codigoPrd']; ?></td>
      <td><?php echo $row_Recordset1['pesoProd']; ?></td>
	  <td><?php echo $row_Recordset1['ordenFabric']; ?></td>
      <td><?php echo $row_Recordset1['tirasAProce']; ?></td>
      
  <td><a href="actualizar_producto.php?idproductos=<?php echo $row_Recordset1['idproductos']; ?>" > <img src='../imagenes/editar.png'  title='Editar productos'></img></a></td>

 <td><a href="borrar_productos.php?idproductos=<?php  echo $row_Recordset1['idproductos']; ?>" ><img src='../imagenes/eliminar.gif' title='Eliminar producto'></img ></a></td>
