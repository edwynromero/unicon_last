...
$num=cantidad($res);
	...
	<td bgcolor="#666666" color="#FFFFFF" align="center"><b>N°</b></td>
		<td bgcolor="#666666" color="#FFFFFF" align="center"><b>Numero del turno</b></td>
	<td bgcolor="#666666" color="#FFFFFF"><b>Tiempo del turno</b></td>
	</tr>';
	...
	<td bgcolor="'.$color.'">'.$numTurno.'</td>
	<td bgcolor="'.$color.'">'.$tiempoTurno.'</td>
		</tr>';
	$contador++;
	}
	$html.='</table>';
